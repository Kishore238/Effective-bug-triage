...
<a href="#" class="navi_tx" style="width:40px;">Welcome&nbsp<%=group %></a>
      ...
      <a href="open.jsp" class="navi_tx" style="width:32px;">Community</a> 
       <a href="vi.jsp" class="navi_tx" style="width:79px;">View Blogs</a> 
       <a href="index.jsp" class="navi_tx" style="width:4px;">Logout</a> 
         
       </div>
      <div class="tp_img1">
        <div class="tp_img2"> <a href="http://all-free-download.com/free-website-templates/"><img src="images/logo.gif" alt="" width="211" height="131" class="logo" /></a> <img src="images/tp_tx.gif" alt="" width="450" height="49" class="tp_tx" />
        <br><br></br></br> </div>
      </div>
    </div>
    <!--Top Block Ends -->
